...
console.log('Дополнительный, не предусмотренный в задании функционал:\n аудиоплеер умеет перейти в состояние, которое было при закрытии плеера"\n (начать воспроизведение с того трека и времени, на котором остановились)');