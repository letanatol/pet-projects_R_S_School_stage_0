  ...
  winter: [
    {
      ...
      button: 'Buy',
      image: './src/images/favorites/01.jpg',
    },
    {
      id: 2,
      title: 'Staff Picks',
      ...
      button: 'Buy',
      image: './src/images/favorites/02.jpg',
    },
    {
      id: 3,
      title: 'Staff Picks',
      ...
      description: 'Auerbach\'s engaging book places the \'Comedy\' within the tradition of epic, tragedy, and philosophy in general, arguing for Dante\'s uniqueness as one who raised he individual and his drama of soul into something of divine significance—an inspired introduction to Dante\'s main themes.',
      button: 'Buy',
      image: './src/images/favorites/03.jpg',
    },
    {
      id: 4,
      title: 'Staff Picks',
      ...
      button: 'Buy',
      image: './src/images/favorites/04.jpg',
    }
  ],
  spring: [
    {
      ...
      button: 'Buy',
      image: './src/images/favorites/05.jpg',
    },
    {
      id: 6,
      title: 'Staff Picks',
      ...
      button: 'Buy',
      image: './src/images/favorites/06.jpg',
    },
    {
      id: 7,
      title: 'Staff Picks',
      ...
      button: 'Buy',
      image: './src/images/favorites/07.jpg',
    },
    {
      id: 8,
      title: 'Staff Picks',
      ...
      button: 'Buy',
      image: './src/images/favorites/08.jpg',
    }
  ],
  summer: [
    {
      ...
      button: 'Buy',
      image: './src/images/favorites/09.jpg',
    },
    {
      id: 10,
      title: 'Staff Picks',
      ...
      button: 'Buy',
      image: './src/images/favorites/10.jpg',
    },
    {
      id: 11,
      title: 'Staff Picks',
      ...
      button: 'Buy',
      image: './src/images/favorites/11.jpg',
    },
    {
      id: 12,
      title: 'Staff Picks',
      ...
      button: 'Buy',
      image: './src/images/favorites/12.jpg',
    }
  ],
  autumn: [
    {
      ...
      button: 'Buy',
      image: './src/images/favorites/13.jpg',
    },
    {
      id: 14,
      title: 'Staff Picks',
      ...
      button: 'Buy',
      image: './src/images/favorites/14.jpg',
    },
    {
      id: 15,
      title: 'Staff Picks',
      ...
      button: 'Buy',
      image: './src/images/favorites/15.jpg',
    },
    {
      id: 16,
      title: 'Staff Picks',
      ...
      button: 'Buy',
      image: './src/images/favorites/16.jpg',
    }
  ]
}
...
export function renderFavorites(filterBy = 'winter') {
  favoritesBooks.innerHTML = favorites[filterBy].map(item => (
    ...
    `<div class="favorites__book" id=${item.id}>
      ...
      <p class="favorites__book-description">${item.description}</p>
      <button class="favorites__book-button">${item.button}</button>
      <div class="favorites__book-image">
        <img src=${item.image} alt="" width="200" height="300" width="200" height="300">
      </div>
    </div>`
  )).join(' ');
